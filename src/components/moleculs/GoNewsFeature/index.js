...
const GoNewsFeature = ({onPress}) => {
    return (
        <View style={{paddingTop: 16,paddingHorizontal: 16}}>
            <View style={{position: 'relative'}}>
                <Image source={require('../../../assets/img/sprint.jpg')} style={{height: 170,width: '100%',borderRadius: 6}} />
            ...
            <View style={{paddingTop: 16,paddingBottom: 20,borderBottomColor: 'E8E9ED',borderBottomWidth: 1}}>
                ...
                <Text style={{fontSize: 14,fontWeight: 'normal',color: '#7A7A7A',marginBottom: 11}}>Pelari asal Ntb menangkan kejuaan internasional di Jepang. Atlit yang mengharumkan nama bangsa bernama zohri.</Text>
